...
export function GradesAdmin() {
	...
	// Définition des colonnes spécifiques pour la vue admin (identiques à celles de l'enseignant)
	...
	return (
		<Flex vertical>
			<Row>
				<Col>
					<Text type="secondary">Vue administrateur - Accès à toutes les évaluations</Text>
				</Col>
			</Row>
